 /* --------------------------------------------------
  * © Copyright 2018 - Photix by Designesia
  * --------------------------------------------------*/
(function($) {
	'use strict';
     ...
     function init_de() {
		 ...
		 jQuery('.f_box').each(function() {
             jQuery(this).find("img").on('load', function() {
                 var h = jQuery(this).css("height");
                 var tpp = jQuery(this).parent().parent();
				 var mt =  Math.floor(parseInt(h)/2)+"px";
                 tpp.find(".f_cap_wrap").css("margin-top", mt);
             }).each(function() {
                 if (this.complete) $(this).load();
             });
         });
		...
		/* --------------------------------------------------
		 ...
		 function de_anim() {
			 ...
			 jQuery('.anim').each(function() {
				 var imagePos = jQuery(this).offset().top;				
				 var hasScroll = $(this).attr('data-scroll');
				 var fx = $(this).attr('data-anim');	
